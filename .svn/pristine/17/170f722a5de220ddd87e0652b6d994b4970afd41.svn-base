...
void AlViewLayout::setDelegate (void* delegate, OnSetFrameCallback onSetFrameCallback)
{
    _delegate = delegate;
    _onSetFrameCallback = onSetFrameCallback;
    
}

void AlViewLayout::applyLayout ()
{
    if (NULL != _delegate && NULL != _onSetFrameCallback)
    {
        _onSetFrameCallback(_delegate, _layoutedRect);
    }
}
